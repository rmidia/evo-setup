# =============================================================================
# Raphael Fernandes - R.MÍDIA
# verification.ps1 Script de Verificação de Ambiente
# Verifica e prepara o ambiente Windows para instalação das aplicações - EVO CRM e EVO GO
# WINDOWS - WSL2 - DOCKER DESKTOP - PYTHON - NODE
# =============================================================================
# USO:
# 1 - Abrir Powershell: 
#     WIN + R -> Digite powershell -> CRTL + SHIFT + ENTER para abrir como Adm
#     
#  2 - Executar Comando no Powershell
#     irm https://raw.githubusercontent.com/rmidia/evo-setup/main/verification.ps1 | iex
# =============================================================================
...
function Write-Banner {
    ...
    Write-Host "  ║         R.MÍDIA — VERIFICAÇÃO                ║" -ForegroundColor DarkCyan
...
function Write-Summary {
    ...
    if ($script:NeedsReboot) {
        ...
        Write-Host ""
        Write-Host "  ✔  Ambiente pronto! Execute o script da aplicação EVO CRM." -ForegroundColor Green
    }
